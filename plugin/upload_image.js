...
function imgBrowserUpload(_width, moduleID) {
    ...
    if (file.type.match(/image.*/)) {
        ...
        reader.onload = function (readerEvent) {
            ...
            image.onload = function (imageEvent) {
                ...
                push(moduleID, { type: 'upload', item: resizedImage }, true);
...
function upload_imageCtrl($rootScope, $scope, API) {
    var moduleID = $scope.moduleID = 'upload_image';
    ...
    $().w2popup({
        ...
        body: '<div id="boxUploadImg" style="width: 100%; height: 100%;"><div class="w2ui-field w2ui-span3"><div>' +
            '<input id="browserFile" onchange="imgBrowserUpload(' + _width + ', \'' + moduleID + '\');" type="file" /></div></div></div>',
